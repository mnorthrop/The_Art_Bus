...
Date:9/24/2012
Description: This is the Yellow Paint product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<img class="productImageColors" alt="yellow color sample" src="../images/yellowPaint.png"/>

<div class="bannerMessageColors">	
<p class="productName">Yellow</p> 
<p class="b2">Adding a touch of yellow will add vibrance to your office.</p>
