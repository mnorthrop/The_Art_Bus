...
Date: 9/24/2012
Description: This is the Gray Paint product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<!--BANNER CODE -->
<img class="productImageColors" alt="gray color sample" src="../images/grayPaint.png"/>

<div class="bannerMessageColors">	
<p class="productName">Gray</p> 
<p class="b2">Adding a touch of gray will add vibrance to your office.</p>
