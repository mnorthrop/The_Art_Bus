...
Date: 9/24/2012
Description: This is the Shapes Painting product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<!--BANNER CODE -->
<img class="productImageShapes" alt="shapes painting" src="../images/painting4.jpg"/>

<div class="bannerMessagePaintings">	
<p class="productName">Shapes </p> 
<p class="b2">Shapes will bring a geometric illusion to your office.</p>
