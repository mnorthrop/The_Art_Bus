...
Date: 9/24/2012
Description: This is the Antique Lamp product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<!--BANNER CODE -->
<img class="productImageLamp2" alt="antique lamp" src="../images/decor4.jpg"/>

<div class="bannerMessageDecor">	
<p class="productName">Antique Desk Lamp</p> 
<p class="b2">This antique lamp brings class back to the office.</p>
