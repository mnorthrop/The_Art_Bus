...
Date: 9/24/2012
Description: This is the City Painting product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<!--BANNER CODE -->
<img class="productImageCity" alt="city painting" src="../images/painting1.jpg"/>

<div class="bannerMessagePaintings">	
<p class="productName">City </p> 
<p class="b2">City is a beutiful cityscape which will add a pop of color to your office.</p>
