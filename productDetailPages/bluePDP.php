...
Date: 9/24/2012
Description: This is the Blue Paint product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<!--BANNER CODE -->
<img class="productImageColors" alt="blue color sample" src="../images/bluePaint.png"/>

<div class="bannerMessageColors">	
<p class="productName">Blue</p> 
<p class="b2">Adding a touch of blue will add vibrance to your office.</p>
