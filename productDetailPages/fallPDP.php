...
Date: 9/24/2012
Description: This is the Fall Painting product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<!--BANNER CODE -->
<img class="productImageFall" alt="fall painting" src="../images/painting5.jpg"/>

<div class="bannerMessagePaintings">	
<p class="productName">Fall </p> 
<p class="b2">Fall will bring a new season to your office.</p>
