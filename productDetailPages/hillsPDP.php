...
Date:9/24/2012
Description: This is the Hills Painting product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<!--BANNER CODE -->
<img class="productImageHills" alt="hills painting" src="../images/painting2.jpg"/>

<div class="bannerMessagePaintings">	
<p class="productName">Hills </p> 
<p class="b2">Hills is a beautiful illusion which will add a pop of color to your office.</p>
