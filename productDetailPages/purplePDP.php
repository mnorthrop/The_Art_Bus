...
Date: 9/24/2012
Description: This is the Purple Paint product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<img class="productImageColors" alt="purple color sample" src="../images/purplePaint.png"/>

<div class="bannerMessageColors">	
<p class="productName">Purple</p> 
<p class="b2">Adding a touch of purple will add vibrance to your office.</p>
