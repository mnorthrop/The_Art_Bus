...
Date:9/24/2012
Description:This is the Spring Painting product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?>  
...
<!--BANNER CODE -->
<img class="productImageSpring" alt="spring painting" src="../images/painting3.jpg"/>

<div class="bannerMessagePaintings">	
<p class="productName">Spring </p> 
<p class="b2">Spring will bring a sense of renewal to your office.</p>
