...
Date: 9/24/2012
Description: This is the Red Paint product detail page. It maintains the same style rules as all other product detail pages. The navigation is pulled in through the PHP require function.
*****************************************/
?> 
...
<img class="productImageColors" alt="red color sample" src="../images/redPaint.png"/>

<div class="bannerMessageColors">	
<p class="productName">Red </p> 
<p class="b2">Adding a touch of Red will add vibrance to your office.</p>
